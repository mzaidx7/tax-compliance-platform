...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Filing state is stored separately from work status and payment status so
     * one field can never express a contradictory combined state.
     */
    public function up(): void
    {
        Schema::create('filing_records', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('filing_records');
    }
};
